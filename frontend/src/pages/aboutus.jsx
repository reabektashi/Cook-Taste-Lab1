        ...
        <div className="container">
          ...
          <div className="text-center mb-5">
            ...
            <p className="lead mb-2">
              At <strong>Cook&amp;Taste</strong>, our passion lies in curating
              exceptional recipes and culinary experiences...
            </p>
            <p className="mb-2">
              Established in 2024, our diverse team includes skilled chefs, food
              bloggers, and nutritionists who love sharing their kitchen secrets.
            </p>
            <p className="mb-0">
              Embark on this culinary adventure with us and uncover exciting
              flavors, helpful tips, and cooking inspiration for every day.
            </p>
          </div>

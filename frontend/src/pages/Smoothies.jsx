...
const SmoothieRecipes = [
  {
    ...
    time: "5 mins",
    img: "/Images/berry-blast.jpg",
    href: "/drinks/berry-blast-smoothie",
    rating: 4.9,
  },
  {
    id: 402,
    ...
    time: "7 mins",
    img: "/Images/green-power.jpg",
    href: "/drinks/green-power-smoothie",
    rating: 4.7,
  },
  {
    id: 403,
    ...
    time: "6 mins",
    img: "/Images/mango-banana.jpg",
    href: "/drinks/mango-banana-smoothie",
    rating: 4.8,
  },
  {
    id: 404,
    ...
    time: "8 mins",
    img: "/Images/peanut-protein.jpg",
    href: "/drinks/peanut-butter-protein-shake",
    rating: 4.6,
  },
  {
    id: 405,
    tag: "SMOOTHIES",
    title: "Tropical Coconut Smoothie",
    time: "7 mins",
    img: "/Images/tropical-coconut.jpg",
    href: "/drinks/tropical-coconut-smoothie",
    rating: 4.5,
  },
  {
    id: 406,
    tag: "SMOOTHIES",
    title: "Chocolate Berry Smoothie",
    time: "9 mins",
    img: "/Images/chocolate-berry.jpg",
    href: "/drinks/chocolate-berry-smoothie",
    rating: 4.4,
  },
];
  ...
  return (
    <section className="breakfast section-gap py-5 aboutus-page">
      <div className="bk-head text-center mb-4">
        <h2 className="bk-title display-5 fw-bold">Smoothie Recipes</h2>
        <h3 className="fs-5 fw-normal mt-3 px-2">
          Creamy, fruity blends to power your day.
        </h3>
      </div>

      <div className="container px-4 bg-transparent">
        <div className="row g-5 justify-content-center">
          {SmoothieRecipes.map((r) => (
